...
🧩 <b><i>Plugins:</i></b> @bzwwplugins_bot
👨‍💻 <b><i>Developer:</i></b> @bzzwwww"""
...
<i>Telegram chat:</i> @bzwwplugins_bot
<i>Plugins:</i> @bzwwplugins_bot
<i>Developer:</i> @bzzwwww"""
...
pl_new = "Send me a plugin.\n\n<b>⚠️ ATTENTION! Downloading plugins from questionable sources may lead to unfortunate consequences.\n" \
         "@bzwwplugins_bot solves most potential issues.</b>"
...
mm_lot_map = "🗺 Smart lot map"
mm_notify_center = "🔔 Notification center"
mm_quick_actions = "⚡ Quick actions"
mm_sales_stats = "📊 Sales stats"
mm_smart_replies = "🧠 Smart autoresponses"
mm_mass_lots = "📦 Bulk lot management"
mm_safe_mode = "🛡 Safe mode"
mm_scheduler = "🕒 Scheduler"
mm_backups = "💾 Backups"

fc_repeat_delivery = "📦 Repeat delivery"
fc_to_stats = "📊 Stats"
fc_open_chat_notifications = "🔔 This chat"
fc_open_announcements = "📣 Announcements"
fc_test_notification = "🧪 Test notification"
fc_clear_lot_map = "🧹 Clear map"
fc_reset_stats = "🧹 Reset stats"
fc_to_autoresponse = "🤖 Autoresponse"
fc_to_templates = "📝 Templates"
fc_to_lots = "📦 Lots"
fc_to_goods_files = "📁 Goods files"
fc_refresh_lots = "🔄 Refresh lots"
fc_toggle_safe_mode = "{} Toggle safe mode"
fc_scheduler_set_time = "🕒 Backup time"
fc_scheduler_disable = "❌ Disable backup"
fc_backup_create = "📦 Create backup"
fc_backup_get = "⬇️ Download backup"
fc_backup_upload = "⬆️ Upload backup"

fc_enabled = "enabled"
fc_disabled = "disabled"
fc_exists = "exists"
fc_missing = "missing"
fc_empty = "no data"
fc_no_recent_events = "• No events yet."
fc_last_map_entry = "• {}: <code>{}</code> -> <code>{}</code> ({})"
fc_lot_map_text = "<b>🗺 Smart lot map</b>\n\n🔗 Active links: <code>{}</code>\n🕘 Relist history entries: <code>{}</code>\n\n<b>Last entry:</b>\n{}"
fc_notification_center_text = "<b>🔔 Notification center</b>\n\n💬 Chat ID: <code>{}</code>\n✅ Core notifications enabled: <code>{}/{}</code>\n📣 Announcements: <code>{}</code>\n📰 Ads: <code>{}</code>\n\nThis screen contains quick links and a notification test."
fc_quick_actions_text = "<b>⚡ Quick actions</b>\n\nDeal cards now include quick reply, templates, repeat delivery, open chat, open deal and a fast jump into statistics.\n\n📦 Saved last deliveries: <code>{}</code>"
fc_sales_stats_text = "<b>📊 Sales stats</b>\n\n🛒 Total deals: <code>{}</code>\n📅 Today: <code>{}</code>\n✅ Successful deliveries: <code>{}</code>\n❌ Delivery errors: <code>{}</code>\n🔁 Successful relists: <code>{}</code>\n⭐ Reviews: <code>{}</code>\n⚠️ Problem deals: <code>{}</code>\n\n<b>Recent events:</b>\n{}"
fc_smart_replies_text = "<b>🧠 Smart autoresponses</b>\n\n🤖 Autoresponse commands: <code>{}</code>\n📝 Answer templates: <code>{}</code>\n🛡 Safe mode: <code>{}</code>\n\nThis section is already linked with the current autoresponse and template system."
fc_mass_lots_text = "<b>📦 Bulk lot management</b>\n\n📦 Lots in auto-delivery config: <code>{}</code>\n📁 Goods files: <code>{}</code>\n🧾 Total products: <code>{}</code>\n🔗 Lots with linked goods file: <code>{}</code>\n\nUse this screen as a quick hub for lots, products and profile refresh."
fc_safe_mode_text = "<b>🛡 Safe mode</b>\n\nCurrent status: <code>{}</code>\n\nWhen enabled, the bot stops risky automatic actions: autoresponse, auto-delivery and auto-restore. Notifications and Telegram control panel continue working."
fc_scheduler_text = "<b>🕒 Scheduler</b>\n\n📦 Auto-backup: <code>{}</code>\n🕘 Last run: <code>{}</code>\n\nAt the moment the scheduler runs automatic backups by time."
fc_backups_text = "<b>💾 Backups</b>\n\n📦 Archive: <code>{}</code>\n🕘 Last modified: <code>{}</code>\n\nYou can quickly create, download or upload a backup here."

feature_repeat_delivery_missing = "No saved delivery for this deal."
feature_repeat_delivery_ok = "Delivery sent again."
feature_repeat_delivery_ok_msg = "📦 Re-sent the saved delivery for deal <code>{}</code>.\n\nItem: <code>{}</code>"
feature_repeat_delivery_err = "Failed to repeat the delivery."
feature_test_notification_body = "🧪 Test notification.\n\nIf you see this message, the current chat can receive notifications.\n\nTime: <code>{}</code>"
feature_test_notification_sent = "Test sent."
feature_safe_mode_on = "Safe mode enabled."
feature_safe_mode_off = "Safe mode disabled."
feature_scheduler_enter_time = "Enter daily auto-backup time in <code>HH:MM</code> format.\nExample: <code>03:00</code>"
feature_scheduler_invalid_time = "❌ Invalid time format. Use <code>HH:MM</code>."
feature_scheduler_saved = "✅ Daily auto-backup saved for <code>{}</code>."
feature_scheduler_disabled = "Auto-backup disabled."
feature_stats_reset = "Statistics reset."
feature_lot_map_cleared = "Lot map cleared."
fc_scheduler_backup_ok = "📦 Scheduler created a backup by schedule <code>{}</code>."
fc_scheduler_backup_error = "❌ Scheduler failed to create a backup by schedule <code>{}</code>."
