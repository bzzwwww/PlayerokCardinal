...
MAIN3 = "73"
"""
Callback for opening the 3rd page of the main settings menu.
"""

REPEAT_DELIVERY = "74"
"""
Callback for repeating the last saved delivery.
Usage: CBT.REPEAT_DELIVERY:deal_id
"""

FEATURE_TEST_NOTIFICATION = "75"
"""
Callback for sending a test notification into the current Telegram chat.
"""

TOGGLE_SAFE_MODE = "76"
"""
Callback for toggling Safe Mode.
"""

SET_BACKUP_SCHEDULE = "77"
"""
Callback for enabling backup scheduler time input.
"""

DISABLE_BACKUP_SCHEDULE = "78"
"""
Callback for disabling automatic backup scheduler.
"""

FEATURE_CREATE_BACKUP = "79"
"""
Callback for creating a backup archive.
"""

FEATURE_GET_BACKUP = "80"
"""
Callback for sending the latest backup archive.
"""

FEATURE_UPLOAD_BACKUP = "81"
"""
Callback for switching into backup upload mode.
"""

RESET_FEATURE_STATS = "82"
"""
Callback for resetting feature statistics.
"""

CLEAR_LOT_MAP = "83"
"""
Callback for clearing the smart lot map.
"""

OPEN_ANNOUNCEMENTS = "84"
"""
Callback for opening announcement notification settings.
"""

SCHEDULER_SET_TIME = "feature_scheduler_set_time"
"""
User-state: expects a message with scheduler time in HH:MM format.
"""
